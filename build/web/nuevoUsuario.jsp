                ...
                <form  method="post" action="Usuarios?new">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="date" class="form-control" id="fechaUsuario" name="fechaUsuario" placeholder="Telefono Usuario" tabindex="3" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="generoUsuario" class="col-lg-1 control-label">Genero</label>
                            <div class="col-lg-5">
                                <input type="radio" name="generoUsuario" id="generoUsuario" value="Masculino" required> Masculino<br>
                                <input type="radio" name="generoUsuario" id="generoUsuario" value="Femenino" required> Femenino<br>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="password" class="form-control" id="passUsuario" name="passUsuario" placeholder="Correo Electronico" tabindex="4" required>
                            </div>
                        </div>
                    </div><br>
