                ...
                <form  method="post" action="Usuarios?new">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control" id="idUsuario" name="idUsuario" placeholder="Documento Identidad" tabindex="1" disabled value="<%=usMod.getId()%>">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="date" class="form-control" id="fechaUsuario" name="fechaUsuario" placeholder="Telefono Usuario" tabindex="3" required value="<%=usMod.getFechaNacimiento()%>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="generoUsuario" class="col-lg-1 control-label">Genero</label>
                            <div class="col-lg-5">
                                <input type="radio" name="generoUsuario" id="generoUsuario" value="Masculino" <% if(usMod.getGenero().equals("Masculino")){ %> checked <% } %> required> Masculino<br>
                                <input type="radio" name="generoUsuario" id="generoUsuario" value="Femenino" <% if(usMod.getGenero().equals("Femenino")){ %> checked <% } %> required> Femenino<br>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="email" class="form-control" id="correoUsuario" name="correoUsuario" placeholder="Correo Electronico" tabindex="4" required value="<%=usMod.getEmail()%>">
                            </div>
                        </div>
                    </div><br>
